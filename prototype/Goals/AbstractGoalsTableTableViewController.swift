//
//  AbstractGoalsTableTableViewController.swift
//  prototype
//
...
class AbstractGoalsTableTableViewController: UITableViewController, dismissCall {
    ...
    var abstractGoals : [AbstractGoals]?
    
    func fetchAbstractGoals(){
        do{
            abstractGoals = try context.fetch(AbstractGoals.fetchRequest())
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "AbstractGoalCell", for: indexPath)

        let Goal = abstractGoals![indexPath.row]
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        let action = UIContextualAction(style:. destructive, title : "Delete"){
            ...
            let abstractGoalToRemove = self.abstractGoals![indexPath.row]
            
            self.context.delete(abstractGoalToRemove)
            do{
